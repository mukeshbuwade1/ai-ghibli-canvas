...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto py-4 px-4">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex items-center gap-8">
              <a href="#" className="font-medium text-gray-600 hover:text-primary transition-colors">How It Works</a>
              <a href="#" className="font-medium text-gray-600 hover:text-primary transition-colors">Pricing</a>
              <a href="#" className="font-medium text-gray-600 hover:text-primary transition-colors">API</a>
              <a href="#" className="font-medium text-gray-600 hover:text-primary transition-colors">Login</a>
        ...
        <section className="py-16 px-4 bg-gradient-to-b from-white to-gray-50">
          <div className="container mx-auto max-w-4xl text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              ...
              Into <span className="bg-gradient-to-r from-primary to-secondary text-transparent bg-clip-text">Studio Ghibli Style</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Turn any photo into beautiful Studio Ghibli artwork with our AI-powered image transformer
            </p>
      ...
      {/* Main Content */}
      <main className={`container mx-auto py-8 px-4 ${uploadedImage || transformedImage ? 'max-w-6xl' : ''}`}>
        {uploadedImage && !transformedImage && (
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col items-center mb-8">
              <h2 className="text-2xl font-bold mb-2">Choose a Ghibli Style</h2>
              <p className="text-gray-500 mb-6">Select the style you want to apply to your image</p>
              
              {/* Style Selection */}
              <div className="w-full bg-white rounded-xl p-6 mb-8">
                <StylePicker 
        ...
        {transformedImage && (
          <section className="max-w-6xl mx-auto">
            <h2 className="text-2xl font-bold mb-6">Your Ghibli Transformation</h2>
            <ResultView 
        ...
        {!uploadedImage && !transformedImage && (
          <section className="py-16">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-center mb-12">Why Use GhibliAI?</h2>
        ...
        {uploadedImage && (
          <div className="mt-8 bg-gray-50 border border-gray-200 rounded-lg p-4 text-center max-w-lg mx-auto">
            <p className="text-sm text-gray-500">
              Free tier: 5 transformations/month | <span className="text-primary font-medium cursor-pointer">Upgrade to Premium</span> for unlimited transformations
            </p>
          </div>
        )}
      </main>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <h2 className="text-xl font-bold bg-gradient-to-r from-primary to-secondary text-transparent bg-clip-text mb-2">
                GhibliAI
              </h2>
              <p className="text-sm text-gray-500">
                Transform your images with Studio Ghibli style
              </p>
            </div>
          ...
          <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-500">
              &copy; {new Date().getFullYear()} GhibliAI | All rights reserved
            </p>
